...
export const GAMES: GameEntry[] = [
  ...
  ge({ id: "sportshub", category: "sports", type: "hub", order: 0,
    ...
    emoji: "ðŸ†", accent: "#fbbf24", status: "All sports",
    bg: "linear-gradient(135deg, rgba(40,30,8,0.95), rgba(15,10,3,0.85))",
    route: "/sports" }),
  ge({ id: "hockey", category: "sports", order: 10,
    ...
    emoji: "ðŸ’", accent: "#67e8f9", status: "New",
  ...
  ge({ id: "baseball", category: "sports", order: 20,
    ...
    emoji: "âš¾", accent: "#fbbf24", status: "Full sim",
  ...
  ge({ id: "football", category: "sports", order: 21,
    ...
    emoji: "ðŸˆ", accent: "#FFB81C", status: "Full sim",
    bg: "linear-gradient(135deg, rgba(26,37,38,0.95), rgba(11,61,46,0.85))",
    route: "/football/hub" }),
  ge({ id: "versus", category: "sports", order: 30,
    name: "Sports Versus", subtitle: "Head-to-head Â· 2 player",
    description: "Baseball + Football pitch-by-pitch / play-call duels. Same-device or online.",
    emoji: "ðŸ¥Š", accent: "#67e8f9", status: "Versus",
    bg: "linear-gradient(135deg, rgba(8,18,40,0.95), rgba(2,8,20,0.85))",
    route: "/versus" }),
  ge({ id: "boxing", category: "sports", order: 40,
    name: "Boxing", subtitle: "Combat Sports Â· 3-round bouts",
    description: "Strategic 2D boxing â€” jab/cross/hook/uppercut vs block/dodge/clinch. Stamina, head/body targeting, Power Shot meter, KO + judges' decision. 2P or vs adaptive CPU.",
    emoji: "ðŸ¥Š", accent: "#f87171", status: "New Â· Phase 1",
    bg: "linear-gradient(135deg, rgba(40,8,8,0.95), rgba(15,3,3,0.85))",
    route: "/boxing" }),

  // â”€â”€ ACTION & COMBAT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ge({ id: "battleforge", category: "action", order: 0,
    ...
    emoji: "âš”ï¸", accent: "#fca5a5", status: "Pick a matchup",
  ...
  ge({ id: "mech", category: "action", order: 10,
    ...
    emoji: "ðŸ¤–", accent: "#fb923c", status: "Builder + combat",
  ...
  ge({ id: "survivor", category: "action", order: 20,
    ...
    emoji: "âš¡", accent: "#fde047", status: "Playable end-to-end",
  ...
  ge({ id: "tankduel", category: "action", order: 30,
    ...
    emoji: "ðŸ’£", accent: "#fb923c", status: "Best-of formats",
  ...
  ge({ id: "strikeforce", category: "action", order: 40,
    ...
    emoji: "ðŸš€", accent: "#67e8f9", status: "Original homage",
    bg: "linear-gradient(135deg, rgba(8,18,40,0.95), rgba(2,8,20,0.85))",
  ...
  ge({ id: "girder", category: "action", order: 50,
    ...
    emoji: "ðŸ—ï¸", accent: "#dc2626", status: "Original homage",
  ...
  ge({ id: "dungeon3d", category: "adventure", order: 4,
    ...
    emoji: "ðŸ°", accent: "#7e22ce", status: "Session 1 Â· 3D",
    bg: "linear-gradient(135deg, rgba(40,8,40,0.95), rgba(10,5,15,0.85))",
    route: "/dungeon3d" }),

  // â”€â”€ ADVENTURE & RPG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ge({ id: "jrpg", category: "adventure", order: 1,
    ...
    emoji: "⚔️", accent: "#fbbf24", status: "Phase 1 · Chapter 1",
  ...
  ge({ id: "olympus", category: "adventure", order: 0,
    ...
    emoji: "ðŸ›ï¸", accent: "#DAA520", status: "Playable",
  ...
  ge({ id: "temporal", category: "adventure", order: 10,
    ...
    emoji: "â³", accent: "#f59e0b", status: "Playable",
    bg: "linear-gradient(135deg, rgba(30,20,8,0.95), rgba(10,8,3,0.85))",
    route: "/temporal" }),
  ...
  ge({ id: "cosmic", category: "space", order: 0,
    ...
    emoji: "ðŸ›¸", accent: "#9be3ff", status: "Playable",
    bg: "linear-gradient(135deg, rgba(8,15,30,0.95), rgba(3,5,12,0.85))",
    route: "/cosmic" }),

  // â”€â”€ STRATEGY & SIM â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ge({ id: "mainevent", category: "strategy", order: 0,
    ...
    emoji: "ðŸ¤¼", accent: "#f87171", status: "New",
  ...
  ge({ id: "cardclash", category: "strategy", order: 10,
    ...
    emoji: "ðŸƒ", accent: "#a78bfa", status: "New",
    bg: "linear-gradient(135deg, rgba(25,15,40,0.95), rgba(8,4,18,0.85))",
    route: "/cardclash" }),
  ...
  ge({ id: "silentdepths", category: "strategy", order: 30,
    ...
    emoji: "ðŸŒŠ", accent: "#67e8f9", status: "Silent Service-style",
    bg: "linear-gradient(135deg, rgba(2,8,30,0.95), rgba(1,3,10,0.85))",
    route: "/classics/depths" }),

  // â”€â”€ CREATE & CARE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ge({ id: "creature", category: "create", order: 0,
    ...
    emoji: "ðŸ¥š", accent: "#86efac", status: "Playable",
  ...
  ge({ id: "potionlab", category: "create", order: 10,
    ...
    emoji: "ðŸ§ª", accent: "#a78bfa", status: "Playable",
  ...
  ge({ id: "stylestudio", category: "create", order: 20,
    ...
    emoji: "ðŸ‘—", accent: "#f9a8d4", status: "Dress-up",
  ...
  ge({ id: "monsterforge", category: "create", order: 30,
    ...
    emoji: "ðŸ‘¹", accent: "#fda4af", status: "Phase 1 Â· 3D builder",
    bg: "linear-gradient(135deg, rgba(60,8,30,0.95), rgba(20,5,20,0.85))",
    route: "/monster-forge" }),

  // â”€â”€ BRAIN & PUZZLE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ge({ id: "wordplay", category: "brain", type: "hub", order: 0,
    ...
    emoji: "ðŸ’¬", accent: "#C084FC", status: "Many games",
    bg: "linear-gradient(135deg, rgba(25,10,40,0.95), rgba(10,4,18,0.85))",
    route: "/wordplay" }),
  ge({ id: "mathblaster", category: "brain", order: 10,
    ...
    emoji: "ðŸ§®", accent: "#a78bfa", status: "Age-scaled",
  ...
  ge({ id: "mazemuncher", category: "brain", order: 20,
    ...
    emoji: "ðŸ‘»", accent: "#fde047", status: "Original homage",
    bg: "linear-gradient(135deg, rgba(10,8,40,0.95), rgba(2,1,10,0.85))",
    route: "/classics/maze" }),

  // â”€â”€ PARTY & ONLINE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ge({ id: "crew", category: "party", order: 0,
    name: "Crew Traitor", subtitle: "Online social deduction Â· 3-10 players",
    description: "Original Among Usâ€“style game. Crew complete tasks; traitors sabotage and tag out crewmates.",
    emoji: "ðŸ›°ï¸", accent: "#9be3ff", status: "Online cross-device",
    bg: "linear-gradient(135deg, rgba(8,18,40,0.95), rgba(2,8,20,0.85))",
    route: "/crew" }),
  ge({ id: "odd", category: "party", order: 10,
    name: "Odd One Out", subtitle: "Social deduction Â· 3-8 players",
    description: "Everyone gets the same secret word â€” except one. Vote out the impostor.",
    emoji: "ðŸ•µï¸", accent: "#fbbf24", status: "Online",
  ...
  ge({ id: "resources", category: "resources", order: 0,
    ...
    emoji: "ðŸ“š", accent: "#fef3c7", status: "Reference",
    bg: "linear-gradient(135deg, rgba(40,30,15,0.95), rgba(15,10,5,0.85))",
    route: "/resources" }),
];
